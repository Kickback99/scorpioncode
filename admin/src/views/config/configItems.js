  ...
  const groups = [
    {
      ...
      items: [
        ...
        { key: 'article_detail.toc_position',        type: 'radio',  label: '文章 toc 位置',    desc: 'toc 置于文章的所在位置',                  icon: Aim,         get: () => config.getValue('article_detail.toc_position'),      set: (v) => config.updateConfig('article_detail.toc_position', v),     options: [{ value: 'outer', label: '外部' }, { value: 'inner', label: '内部' }] },
        // ===== article_list =====
    ...
    },
    {
      ...
      items: [
        ...
        // ===== notice_load_mode =====
        { key: 'notice_load_mode',                   type: 'radio',  label: '公告加载方式',   desc: '公告列表的加载方式',                      icon: Tickets,        get: () => config.getValue('notice_load_mode'),            set: (v) => config.updateConfig('notice_load_mode', v),               options: [{ value: 'scroll', label: '滚动加载' }, { value: 'pagination', label: '分页加载' }] },
        // ===== captcha =====
