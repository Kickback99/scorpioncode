<template>
  <v-container class="profile-center py-6" :style="{ '--profile-center-scale': handleFontScale, '--empty-state-scale': handleFontScale }">
      <div>
        <!-- 使用动态 direction 属性 -->
        <v-sheet>
          <v-tabs 
        ...
        >
          <v-tab value="profile">
            <v-icon class="mt-1 mr-2" size="large">mdi-account</v-icon>
            个人资料
          </v-tab>
